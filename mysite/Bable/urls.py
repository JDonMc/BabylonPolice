...
urlpatterns = [
	...
	url(r'^vote_for_legislative/(?P<space>[\w-]+)/$', views.vote_for_legislative, name='vote_for_legislative'),
	url(r'^vote_for_administrative/(?P<space>[\w-]+)/$', views.vote_for_administrative, name='vote_for_administrative'),
	url(r'^vote_for_executive/(?P<space>[\w-]+)/$', views.vote_for_executive, name='vote_for_executive'),
	url(r'^vote_for_judiciary/(?P<space>[\w-]+)/$', views.vote_for_judiciary, name='vote_for_judiciary'),
