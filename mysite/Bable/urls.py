...
urlpatterns = [
	...
	url(r'^create_storefront/$', views.create_storefront, name='create_storefront'),
	url(r'^storefront/(?P<author>[\w-]+)/(?P<storefront_title>[\w-]+)/$', views.storefront, name='storefront'),
    ...
    path('api/checkout-session/<price>/<post_id>/<storefront_id>/', views.create_checkout_session, name='api_checkout_session'),
