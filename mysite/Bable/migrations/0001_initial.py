# Generated by Django 3.2.20 on 2023-07-22 02:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.OneToOneField(default=None, null=True, on_delete=django.db.models.deletion.PROTECT, to='Bable.author')),
            ],
        ),
        migrations.AddField(
            model_name='post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stripe_private_key', models.CharField(default='', max_length=600)),
                ('stripe_api_secret', models.CharField(default='', max_length=600)),
