...
urlpatterns = [
	...
	url(r'^user/(?P<user_id>[\w-]+)/$', views.tob_user_view, name='tob_user_view'),
	url(r'^user/(?P<user_id>[\w-]+)/count/(?P<count>[\w-]+)/$', views.tob_user_view_count, name='tob_user_view_count'),
	url(r'^user/(?P<user_id>[\w-]+)/spaces/count/(?P<count>[\w-]+)/$', views.tob_users_spaces, name='tob_users_spaces'),
	url(r'^user/(?P<user_id>[\w-]+)/sponsor/(?P<sponsor>[\w-]+)/$', views.tob_users_sponsor, name='tob_users_sponsor'),
	url(r'^user/(?P<user_id>[\w-]+)/sponsors/count/(?P<count>[\w-]+)/$', views.tob_users_sponsors, name='tob_users_sponsors'),
	url(r'^user/(?P<user_id>[\w-]+)/space/(?P<space_id>[\w-]+)/count/(?P<count>[\w-]+)/$', views.tob_users_space, name='tob_users_space'),
	url(r'^user/(?P<user_id>[\w-]+)/space/(?P<space_id>[\w-]+)/sponsor/(?P<sponsor>[\w-]+)/$', views.tob_users_spaces_sponsor, name='tob_users_spaces_sponsor'),
	url(r'^user/(?P<user_id>[\w-]+)/space/(?P<space_id>[\w-]+)/post/(?P<post_id>[\w-]+)/$', views.tob_users_spaces_post, name='tob_users_spaces_post'),
	url(r'^user/(?P<user_id>[\w-]+)/vote/(?P<vote>[\w-]+)/$', views.tob_users_vote, name='tob_users_vote'),
	url(r'^user/(?P<user_id>[\w-]+)/votes/count/(?P<count>[\w-]+)/$', views.tob_users_votes, name='tob_users_votes'),
	url(r'^user/(?P<user_id>[\w-]+)/space/(?P<space>[\w-]+)/post/(?P<post>[\w-]+)/count/(?P<count>[\w-]+)/$', views.tob_users_spaces_post_count, name='tob_users_spaces_post_count'),
	url(r'^user/(?P<user_id>[\w-]+)/space/(?P<space>[\w-]+)/post/(?P<post>[\w-]+)/comment/(?P<comment>[\w-]+)/$', views.tob_users_spaces_post_comment, name='tob_users_spaces_post_comment'),
	url(r'^user/(?P<user_id>[\w-]+)/posts/count/(?P<count>[\w-]+)/$', views.tob_users_posts, name='tob_users_posts'),
	url(r'^user/(?P<user_id>[\w-]+)/post/(?P<post>[\w-]+)/count/(?P<count>[\w-]+)/$', views.tob_users_post, name='tob_users_post'),
	url(r'^user/(?P<user_id>[\w-]+)/post/(?P<post>[\w-]+)/comment/(?P<comment>[\w-]+)/$', views.tob_users_posts_comment, name='tob_users_posts_comment'),
	url(r'^user/(?P<user_id>[\w-]+)/examples/count/(?P<count>[\w-]+)/$', views.tob_users_examples, name='tob_users_examples'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionaries/count/(?P<count>[\w-]+)/$', views.tob_users_dics, name='tob_users_dics'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/count/(?P<count>[\w-]+)/$', views.tob_users_dic, name='tob_users_dic'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/word/(?P<word>[\w-]+)/count/(?P<count>[\w-]+)/$', views.tob_users_dic_word_count, name='tob_users_dic_word_count'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/word/(?P<word>[\w-]+)/pronunciation/(?P<pronunciation_id>[\w-]+)/$', views.tob_users_dic_word_pronunciations, name='tob_users_dic_word_pronunciations'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/word/(?P<word>[\w-]+)/attribute/(?P<attribute>[\w-]+)/$', views.tob_users_dic_word_attribute, name='tob_users_dic_word_attribute'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/word/(?P<word>[\w-]+)/similarity/(?P<similarity>[\w-]+)/$', views.tob_users_dic_word_similarity, name='tob_users_dic_word_similarity'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/word/(?P<word>[\w-]+)/translation/(?P<translation>[\w-]+)/$', views.tob_users_dic_word_translation, name='tob_users_dic_word_translation'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/word/(?P<word>[\w-]+)/example/(?P<example>[\w-]+)/$', views.tob_users_dic_word_example, name='tob_users_dic_word_example'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/word/(?P<word>[\w-]+)/story/(?P<story>[\w-]+)/$', views.tob_users_dic_word_story, name='tob_users_dic_word_story'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/word/(?P<word>[\w-]+)/relation/(?P<relation>[\w-]+)/$', views.tob_users_dic_word_relation, name='tob_users_dic_word_relation'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/word/(?P<word>[\w-]+)/sponsor/(?P<sponsor>[\w-]+)/$', views.tob_users_dic_word_sponsor, name='tob_users_dic_word_sponsor'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/word/(?P<word>[\w-]+)/space/(?P<space>[\w-]+)/$', views.tob_users_dic_word_space, name='tob_users_dic_word_space'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/words/count/(?P<count>[\w-]+)/$', views.tob_users_dic_words, name='tob_users_dic_words'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/wordgroups/count/(?P<count>[\w-]+)/$', views.tob_users_dic_wordgroups, name='tob_users_dic_wordgroups'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/translations/count/(?P<count>[\w-]+)/$', views.tob_users_dic_translations, name='tob_users_dic_translations'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/sentences/count/(?P<count>[\w-]+)/$', views.tob_users_dic_sentences, name='tob_users_dic_sentences'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/sentences/(?P<sentence>[\w-]+)/renditions/count/(?P<count>[\w-]+)/$', views.tob_users_dic_renditions, name='tob_users_dic_renditions'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/analyses/count/(?P<count>[\w-]+)/$', views.tob_users_dic_analyses, name='tob_users_dic_analyses'),
	url(r'^user/(?P<user_id>[\w-]+)/dictionary/(?P<dictionary>[\w-]+)/votes/count/(?P<count>[\w-]+)/$', views.tob_users_dic_votes, name='tob_users_dic_votes'),
	...
	url(r'^buy_users_dic/(?P<user_id>[\w-]+)/(?P<dictionary>[\w-]+)/$', views.buy_users_dic, name='buy_users_dic'),
	url(r'^delete_own_word/(?P<user_id>[\w-]+)/(?P<dictionary>[\w-]+)/(?P<word>[\w-]+)/$', views.delete_own_word, name='delete_own_word'),
	url(r'^delete_own_word_id/(?P<word_id>[\w-]+)/$', views.delete_own_word_id, name='delete_own_word_id'),
	url(r'^delete_own_dic/(?P<user_id>[\w-]+)/(?P<dictionary>[\w-]+)/$', views.delete_own_dic, name='delete_own_dic'),
	url(r'^delete_bought_dic/(?P<user_id>[\w-]+)/(?P<dictionary>[\w-]+)/$', views.delete_bought_dic, name='delete_bought_dic'),
	url(r'^delete_own_com/(?P<com>[\w-]+)/(?P<which>[\w-]+)/$', views.delete_own_com, name='delete_own_com'),
	url(r'^delete_own_attr/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<attr>[\w-]+)/$', views.delete_own_attr, name='delete_own_attr'),
	url(r'^delete_own_attr_def/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<attr>[\w-]+)/(?P<def>[\w-]+)/$', views.delete_own_attr_def, name='delete_own_attr_def'),
	url(r'^delete_own_attr_syn/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<attr>[\w-]+)/(?P<syn>[\w-]+)/$', views.delete_own_attr_syn, name='delete_own_attr_syn'),
	url(r'^delete_own_attr_ant/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<attr>[\w-]+)/(?P<ant>[\w-]+)/$', views.delete_own_attr_ant, name='delete_own_attr_ant'),
	url(r'^delete_own_attr_hom/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<attr>[\w-]+)/(?P<hom>[\w-]+)/$', views.delete_own_attr_hom, name='delete_own_attr_hom'),
	url(r'^delete_own_pron/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<pron>[\w-]+)/$', views.delete_own_pron, name='delete_own_pron'),
	url(r'^delete_own_exam/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<exam>[\w-]+)/$', views.delete_own_exam, name='delete_own_exam'),
	url(r'^delete_own_trans/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<trans>[\w-]+)/$', views.delete_own_trans, name='delete_own_trans'),
	url(r'^delete_own_stor/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<stor>[\w-]+)/$', views.delete_own_stor, name='delete_own_stor'),
	url(r'^delete_own_rela/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<rela>[\w-]+)/$', views.delete_own_rela, name='delete_own_rela'),
	url(r'^delete_own_conn/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<rela>[\w-]+)/(?P<conn>[\w-]+)/$', views.delete_own_conn, name='delete_own_conn'),
	url(r'^delete_own_spon/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<spon>[\w-]+)/$', views.delete_own_spon, name='delete_own_spon'),
	url(r'^delete_own_spons/(?P<spon>[\w-]+)/$', views.delete_own_spons, name='delete_own_spons'),
	url(r'^delete_own_spac/(?P<user_id>[\w-]+)/(?P<dic>[\w-]+)/(?P<word>[\w-]+)/(?P<spac>[\w-]+)/$', views.delete_own_spac, name='delete_own_spac'),
	url(r'^delete_own_post/(?P<user_id>[\w-]+)/(?P<post>[\w-]+)/$', views.delete_own_post, name='delete_own_post'),
	url(r'^delete_own_space/(?P<user_id>[\w-]+)/(?P<space>[\w-]+)/$', views.delete_own_space, name='delete_own_space'),
	...
	url(r'^tob_buy_space/(?P<user_id>[\w-]+)/(?P<space>[\w-]+)/$', views.tob_buy_space, name='tob_buy_space'),
	url(r'^submit_buy_space_form/(?P<space_id>[\w-]+)/$', views.submit_buy_space_form, name='submit_buy_space_form'),
	url(r'^tob_remove_space/(?P<user_id>[\w-]+)/(?P<space>[\w-]+)/$', views.tob_remove_space, name='tob_remove_space'),
	url(r'^tob_save_space/(?P<user_id>[\w-]+)/(?P<space>[\w-]+)/$', views.tob_save_space, name='tob_save_space'),
	url(r'^tob_unsave_space/(?P<user_id>[\w-]+)/(?P<space>[\w-]+)/$', views.tob_unsave_space, name='tob_unsave_space'),
	url(r'^tob_save_exa/(?P<user_id>[\w-]+)/(?P<exa>[\w-]+)/$', views.save_own_exa, name='save_own_exa'),
	url(r'^tob_save_com/(?P<user_id>[\w-]+)/(?P<com>[\w-]+)/$', views.tob_save_com, name='tob_save_com'),
	url(r'^tob_save_votestyle/(?P<user_id>[\w-]+)/(?P<votestyleid>[\w-]+)/$', views.tob_save_votestyle, name='tob_save_votestyle'),
	...
	url(r'^kick_vote_for_member/(?P<space_id>[\w-]+)/(?P<username>[\w-]+)/$', views.kick_vote_for_member, name='kick_vote_for_member'),
	url(r'^vote_for_legislative/(?P<space_id>[\w-]+)/(?P<username>[\w-]+)/$', views.vote_for_legislative, name='vote_for_legislative'),
	url(r'^vote_for_administrative/(?P<space_id>[\w-]+)/(?P<username>[\w-]+)/$', views.vote_for_administrative, name='vote_for_administrative'),
	url(r'^vote_for_executive/(?P<space_id>[\w-]+)/(?P<username>[\w-]+)/$', views.vote_for_executive, name='vote_for_executive'),
	url(r'^vote_for_judiciary/(?P<space_id>[\w-]+)/(?P<username>[\w-]+)/$', views.vote_for_judiciary, name='vote_for_judiciary'),
	url(r'^create_storefront/(?P<users_dic_id>[\w-]+)/$', views.create_storefront, name='create_storefront'),
	url(r'^storefront/(?P<author>[\w-]+)/(?P<dictionary_id>[\w-]+)/(?P<storefront_title>[\w-]+)/$', views.storefront, name='storefront'),
	url(r'^checkout/(?P<author>[\w-]+)/(?P<dictionary_id>[\w-]+)/(?P<storefront_title>[\w-]+)/$', views.checkout, name='checkout'),
	url(r'^roadmap/$', views.roadmap, name='roadmap'),
	url(r'^upload_file/$', views.upload_file, name='upload_file'),
	url(r'^drawing/(?P<author>[\w-]+)/(?P<name>[\w-]+)/$', views.drawing, name='drawing'),
	url(r'^svg_to_gcode/$', views.svg_to_gcode, name='svg_to_gcode'),
