# Generated by Django 4.1.5 on 2023-06-17 03:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='the_vote_name',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='name', to='Bable.word_source'),
        ),
        migrations.AddField(
            model_name='votes_source',
            name='the_vote_style',
            field=models.ManyToManyField(default=None, related_name='style', to='Bable.word_source'),
        ),
        migrations.CreateModel(
            name='Votes',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('the_vote_name', models.CharField(default='', max_length=200)),
                ('url2', models.URLField(blank=True, default='', max_length=2000)),
                ('votes', models.IntegerField(default=0)),
                ('author', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='Bable.author')),
                ('the_vote_style', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='name', to='Bable.spacesource')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('received_messages', models.ManyToManyField(default=None, related_name='received_messages', to='Bable.message')),
                ...
                ('sent_messages', models.ManyToManyField(default=None, related_name='sent_messages', to='Bable.message')),
