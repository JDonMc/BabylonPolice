# Generated by Django 3.2.24 on 2024-06-07 22:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_of_product', models.CharField(default='Remote', max_length=200)),
                ('product_type', models.CharField(choices=[('unspecified', 'Unspecified'), ('package_post', 'Posted Package'), ('package_courier', 'Courier Routes Package'), ('package_direct', 'Choose A Courier'), ('package_pick_up', 'Pick Up Yourself (with a pick-up)'), ('package_collect', 'Collect Yourself (by hand)'), ('link', 'Collect Links'), ('poem', 'Just Words'), ('tickets', 'Event Tickets'), ('classes', 'Classes'), ('class_material', 'Class Material'), ('other', 'Other Deal')], default='unspecified', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applied_dictionaries', models.ManyToManyField(default=None, related_name='applied_dictionaries', to='Bable.Dictionary_Source')),
                ('applied_votestyles', models.ManyToManyField(default=None, related_name='applied_votestyles', to='Bable.Votes')),
                ('availabilities', models.ManyToManyField(default=None, related_name='availabilities', to='Bable.Availability')),
                ...
                ('drawings', models.ManyToManyField(default=None, to='Bable.Drawing')),
                ('employed_by', models.ManyToManyField(default=None, related_name='employed_by', to='Bable.Author')),
                ('employees', models.ManyToManyField(default=None, related_name='employees', to='Bable.Author')),
                ...
                ('loans', models.ManyToManyField(default=None, to='Bable.Loan')),
                ('notifications', models.ManyToManyField(default=None, to='Bable.Notification')),
                ('past_votes', models.ManyToManyField(default=None, related_name='past_votes', to='Bable.Votings')),
                ...
                ('saless', models.ManyToManyField(default=None, to='Bable.Sale')),
                ...
                ('search_urls', models.ManyToManyField(default=None, to='Bable.SearchURL')),
                ('sent_messages', models.ManyToManyField(default=None, related_name='sent_messages', to='Bable.Comment_Source')),
                ('shared_with_availabilities', models.ManyToManyField(default=None, related_name='shared_with_availabilities', to='Bable.Availability')),
                ('spaces', models.ManyToManyField(blank=True, default=None, related_name='spaces', to='Bable.Space')),
                ('storefronts', models.ManyToManyField(default=None, to='Bable.Storefront')),
                ('student_of', models.ManyToManyField(default=None, related_name='student_of', to='Bable.Author')),
                ('students', models.ManyToManyField(default=None, related_name='students', to='Bable.Author')),
